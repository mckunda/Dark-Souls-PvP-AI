...
pub unsafe fn ReadPlayer(c: &mut Character, processHandle: HANDLE, characterId: i32){
    ...
    c.rotation = (c.rotation + std::f32::consts::PI) * (180.0 / std::f32::consts::PI);
